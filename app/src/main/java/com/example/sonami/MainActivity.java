...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            String jsonResponse = "";
            // ensure it proceeds if the url is not null
            if (url == null){
                return jsonResponse;
            }
            ...
            try {
                ...
                //if the response code is 200(successful) we go ahead to read and parse it
                ...
                Log.e(LOG_TAG, "Problem retrieving the earthquakeJSON result.", e);
            } finally {
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            //checks if the json string is empty or null return early
